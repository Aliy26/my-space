...
const projectsUploadsDirectory = path.resolve(
  serverRoot,
  "uploads",
  "projects",
);
...
export const logger = pino({
  ...
  transport:
    !isProduction && hasPrettyLogger ? { target: "pino-pretty" } : undefined,
});
...
app.use(
  "/uploads/projects",
  express.static(path.resolve(serverRoot, "uploads", "projects")),
);
